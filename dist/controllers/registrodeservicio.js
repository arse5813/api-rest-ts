...
const registrodeservicio_1 = require("../services/registrodeservicio");
const getItem = ({ params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = params;
        const response = yield (0, registrodeservicio_1.getTramo)(id);
...
const getItems = (rq, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, registrodeservicio_1.getTramos)();
        res.send(response);
    }
    catch (e) {
...
const updateItem = ({ params, body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = params;
        const response = yield (0, registrodeservicio_1.updateTramo)(id, body);
        res.send(response);
    }
    catch (e) {
...
const postItem = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const responseTramo = yield (0, registrodeservicio_1.interTramo)(body);
...
const deleteItem = ({ params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = params;
        const response = yield (0, registrodeservicio_1.deleteTramo)(id);
        res.send(response);
    }
    catch (e) {
