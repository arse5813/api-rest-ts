...
exports.comparaPassword = exports.encrypt = void 0;
...
const comparaPassword = (pass, passHash) => __awaiter(void 0, void 0, void 0, function* () {
    const isCorrect = yield (0, bcryptjs_1.compare)(pass, passHash);
    return isCorrect;
});
exports.comparaPassword = comparaPassword;
